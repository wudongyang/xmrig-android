...
LOCAL_SRC_FILES :=    \
    ...
    $(XMRIG_SRC_PATH)/src/common/log/BasicLog.cpp \
...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../../src $(LOCAL_PATH)/../../src/common $(LOCAL_PATH)/../libuv/include $(LOCAL_PATH)/../../src/3rdparty
...
LOCAL_CFLAGS +=   -DXMRIG_NO_HTTPD -DXMRIG_NO_API -DXMRIG_NO_LIBCPUID -DXMRIG_NO_TLS -DXMRIG_NO_ASM -DXMRIG_ARM
